  ...
  _createClass(Ajax, null, [{
    ...
    value: function request(method, endPoint, accept, body, timeout, ontimeout, callback) {
      if (window.XDomainRequest) {
        var req = new window.XDomainRequest(); // IE8, IE9
...
})(typeof(_exports) === "undefined" ? window.Phoenix = window.Phoenix || {} : _exports);

console.log("exports", _exports);
